    ...
    rules: [
      {
        ...
        // 防止页面触发
        excludeMatches:
          '[text^="我已阅读"||text*="协议"||text*="登录"||text*="退款"||text$="应用更新"||text^="删除"||text*="清除"||text*="播放"||text="浏览器打开"||text$="分享文件"||text="加入黑名单"][name!$=".CheckBox"&&name!$=".EditText"&&vid!$=".checkbox"][childCount=0][visibleToUser=true]',
        matches: [
