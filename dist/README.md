...
|CSDN|4|<li>分段广告-信息流广告<li>评价提示-软件好评弹窗<li>权限提示-通知权限<li>分段广告-底部广告|
...
|爱奇艺|4|<li>开屏广告<li>局部广告-顶部卡片广告<li>权限提示-通知权限<li>全屏广告-播放页-插入广告|
|爱奇艺极速版|1|<li>开屏广告|
|爱奇艺体育|1|<li>开屏广告|
|爱企查|1|<li>权限提示-通知权限|
...
|百度网盘|6|<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>功能类-签到<li>权限提示-通知权限<li>评价提示<li>局部广告-悬浮广告|
...
|比翼多开|1|<li>全屏广告-弹窗广告|
|必剪|1|<li>权限提示-通知权限|
|哔哩哔哩|14|<li>开屏广告<li>局部广告-评论区顶部公告横幅<li>分段广告-动态推荐卡片广告<li>分段广告-视频底部与评论区中间卡片广告<li>局部广告-视频页广告<li>局部广告-直播间卡片广告<li>权限提示-通知权限<li>分段广告-首页推荐视频卡片广告<li>局部广告-个性化内容推荐弹窗<li>全屏广告-会员弹窗<li>全屏广告-分享稿件弹窗<li>分段广告-搜索结果广告<li>分段广告-视频详情页下方推广<li>功能类-自动关闭故事模式|
|哔哩哔哩-国际版|5|<li>功能类-关闭弹幕<li>通知提示-全程赛程<li>评价提示-评论区满意度评价<li>评价提示-APP评分<li>权限提示-通知权限|
...
|菜鸟|6|<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>权限提示-通知权限<li>评价提示<li>功能类-询问[是否要查询包裹]弹窗<li>功能类-包裹页面-自动展开更多物流信息|
|畅听FM|1|<li>全屏广告-弹窗广告|
...
|东方财富|1|<li>权限提示-通知权限|
|懂车帝|8|<li>分段广告-首页推荐卡片广告<li>局部广告-右下角悬浮窗<li>局部广告-文章底部卡片广告<li>局部广告-评论区信息流广告<li>权限提示-通知权限<li>局部广告-选车页卡片广告<li>局部广告-车型页面右下角直播悬浮窗<li>评价提示|
...
|抖音|15|<li>局部广告-关闭用户推荐<li>功能类-设置无声进入抖音弹窗<li>权限提示-通知权限<li>功能类-自动勾选原图<li>其他-休息提醒<li>功能类-[添加快捷方式到桌面]弹窗<li>全屏广告-视频播放中途插入的打招呼界面<li>全屏广告-关闭商城推荐<li>局部广告-拍同款弹窗<li>全屏广告-[去首页商城]弹窗<li>全屏广告-低价秒杀券弹窗<li>权限提示-请求访问通讯录弹窗<li>权限提示-定位权限<li>全屏广告-汽水音乐VIP<li>其他-个性化推荐弹窗|
...
|二柄|1|<li>分段广告|
|番茄免费小说|9|<li>局部广告-阅读页面广告<li>局部广告-首页右侧悬浮广告<li>全屏广告-弹窗广告<li>全屏广告-阅读页面关注作者弹窗<li>分段广告-阅读页面广告<li>评价提示-请求好评弹窗<li>权限提示-通知权限<li>全屏广告<li>全屏广告-会员福利弹窗|
|返利|1|<li>全屏广告-弹窗广告|
|飞客|1|<li>全屏广告-弹窗广告|
...
|华为应用市场|6|<li>开屏广告<li>功能类-应用更新页面-点击[查看更多]<li>全屏广告-热门应用推荐弹窗<li>局部广告-卡片广告<li>权限提示-通知权限<li>功能类-自动安装应用|
...
|今日头条|10|<li>局部广告-浮窗广告<li>权限提示-通知权限<li>全屏广告-竖屏视频广告<li>分段广告-信息流广告<li>局部广告-底部话题推荐弹窗<li>功能类-自动观看广告视频<li>局部广告-底部热榜弹窗<li>功能类-[关联抖音账号]弹窗<li>功能类-[下次打开APP默认进入发现频道]弹窗<li>全屏广告-弹窗广告|
|金山文档|2|<li>局部广告-列表卡片广告<li>权限提示-通知权限|
...
|酷安|5|<li>开屏广告<li>分段广告-信息流广告<li>权限提示-通知权限<li>局部广告-[大家还下载了]应用推荐<li>局部广告-信息流广告|
...
|联想浏览器HD|1|<li>权限提示-通知权限|
|联想应用中心|1|<li>权限提示-通知权限|
|两步路户外助手|2|<li>全屏广告-弹窗广告<li>权限提示-通知权限|
|邻里邦|1|<li>功能类-自动签到|
|聆听音乐|1|<li>全屏广告-弹窗广告|
...
|萌妹|1|<li>全屏广告-弹窗广告|
|咪咕快游|1|<li>更新提示|
|咪咕视频|3|<li>局部广告-右下角小广告<li>权限提示-通知权限<li>全屏广告-弹窗广告|
|咪咕音乐|1|<li>更新提示|
|米家|1|<li>局部广告-卡片广告|
...
|皮皮喵|1|<li>全屏广告|
|皮皮虾|6|<li>权限提示-通知权限<li>局部广告-右上角红包悬浮窗<li>评价提示<li>全屏广告-集五福弹窗<li>局部广告-卡片广告<li>分段广告-信息流广告|
...
|起点读书|10|<li>开屏广告<li>青少年模式<li>全屏广告-活动弹窗<li>权限提示-通知权限<li>局部广告-悬浮广告<li>功能类-起点中文网登录自动确认<li>局部广告-信息流广告<li>其他-福利中心看视频后获得奖励<li>全屏广告-红包弹窗<li>功能类-移动网络下自动点击播放视频|
...
|什么值得买|3|<li>全屏广告-弹窗广告<li>权限提示-请求读取剪贴板权限弹窗<li>权限提示-通知权限|
...
|网易有道词典|8|<li>分段广告-单词页面卡片广告<li>全屏广告-弹窗广告<li>全屏广告-VIP弹窗<li>评价提示<li>功能类-点击显示释义<li>局部广告-卡片广告<li>功能类-关闭单词页面[去复习]提示<li>全屏广告-开学福利弹窗|
...
|五寸方|1|<li>全屏广告-弹窗广告|
|西瓜视频|2|<li>权限提示-通知权限<li>全屏广告-红包弹窗|
|息壤阅读|1|<li>局部广告-悬浮广告|
|稀饭动漫|1|<li>全屏广告-弹窗广告|
...
|闲鱼|9|<li>权限提示-通知权限<li>权限提示<li>全屏广告-红包弹窗<li>分段广告-搜索页面广告<li>功能类-自动点击[查看原图]<li>功能类-自动选中发送原图<li>功能类-闲鱼币<li>功能类-背包使用道具<li>功能类-扱骰子寻宝|
...
|小米运动健康|3|<li>评价提示-好评弹窗<li>权限提示-权限提醒<li>全屏广告-活动弹窗|
|小柿子|1|<li>全屏广告-弹窗广告|
|小特|1|<li>开屏广告|
...
|掌上生活|4|<li>全屏广告-首页弹窗广告<li>局部广告-右侧悬浮广告<li>权限提示-通知权限<li>权限提示-定位权限|
...
|正气|1|<li>全屏广告-弹窗广告|
|支付宝|17|<li>全屏广告-关闭花呗升级弹窗<li>权限提示-定位权限<li>权限提示-通知权限<li>功能类-设置支付宝小组件<li>全屏广告-借呗消费信贷协议<li>功能类-支付后自动点击完成<li>全屏广告-弹窗广告<li>全屏广告-"下次支付用花呗"弹窗<li>分段广告-扫码乘车后出现的广告<li>功能类-关闭免密支付开关<li>分段广告-服务消息页面-卡片广告<li>全屏广告-[0元下单权益]弹窗<li>局部广告-卡片广告<li>其他-蚂蚁理财社区-[加入同路人]弹窗<li>全屏广告-[银行卡还款服务升级]弹窗<li>开屏广告-小程序开屏广告<li>功能类-自动授权登录|
|芝士漫画|1|<li>全屏广告-弹窗广告|
|知到|1|<li>权限提示-通知权限|
...
|中国电信|6|<li>功能类-软件更新/安装后的用户引导<li>全屏广告-浮窗广告<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>功能类-右下角客服悬浮窗<li>局部广告-悬浮广告|
...
|中国农业银行|2|<li>权限提示-定位权限<li>权限提示-通知权限|
|中国移动|6|<li>全屏广告-首页弹窗广告<li>权限提示-通知权限<li>权限提示-请求获取剪贴板权限弹窗<li>局部广告-右侧悬浮小图标<li>评价提示-请求好评弹窗<li>权限提示-通讯录权限申请弹窗|
...
|中国银行|1|<li>全屏广告-弹窗广告|
|中国邮政|1|<li>全屏广告-首页弹窗|
|中信银行|3|<li>全屏广告-弹窗广告<li>权限提示-通知权限<li>局部广告-理财产品悬浮广告|
|中羽在线|1|<li>全屏广告-弹窗广告|
|主题|1|<li>全屏广告-弹窗广告|
